  ...
  return (
    <div className="min-h-screen bg-white dark:bg-surface-dark overflow-x-hidden transition-colors duration-200">
      ...
      <section className="bg-white dark:bg-surface-dark border-b border-gray-200 dark:border-border-dark transition-colors duration-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3 sm:py-6 md:py-8 lg:py-12">
          {/* Subscription Status */}
          <div className="flex items-center gap-2 mb-2 sm:mb-4 md:mb-6">
            <div className="w-4 h-4 sm:w-5 sm:h-5 bg-green-500 dark:bg-green-600 rounded-full flex items-center justify-center transition-colors duration-200">
              <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
            </div>
            <p className="text-green-600 dark:text-green-400 font-medium text-xs sm:text-sm transition-colors duration-200">{TEXT.subscriptionStatus}</p>
          </div>

          {/* Main Heading */}
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-ink-dark mb-2 sm:mb-4 md:mb-6 leading-tight transition-colors duration-200">
            {noResults ? (
              TEXT.headingNoJobs
            ) : (
          ...
          {!noResults && jobs.length > 0 && (
            <div className="hidden sm:flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-2 sm:gap-3 text-sm sm:text-base text-gray-600 dark:text-ink-dark-soft transition-colors duration-200">
